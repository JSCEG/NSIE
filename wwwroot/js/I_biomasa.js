        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                datosExpendios = response.filter(function (coordenada) {
                    return coordenada.clasificacion === "Bioenergía";
                });
                    ...
                    if (camposVisiblesGlobal.includes("RazonSocial")) {
                        ...
                        switch (coordenada.tipoPermiso) {
                            ...
                            case "Expendio al Público de Gas Licuado de Petróleo mediante Estación de Servicio con fin Específico":
                                ...
                                break; */
                            default:
                                imgSrc = 'https://cdn.sassoapps.com/img_snier/vistas/biomasai.png'; // Ícono por defecto si no hay coincidencia
                                break;
                        }
                ...
                var iconoExpendio = new iconoBase({ iconUrl: 'https://cdn.sassoapps.com/img_snier/vistas/biomasai.png' });
                ...
                for (var j = 0; j < response.length; j++) {
                    ...
                    if (coordenada.clasificacion === "Bioenergía") {
                        var iconoActual;
...
mapas[0].createPane('pane_Residuosindustriales_0');
mapas[0].getPane('pane_Residuosindustriales_0').style.zIndex = 400;
mapas[0].getPane('pane_Residuosindustriales_0').style['mix-blend-mode'] = 'normal';
...
mapas[0].addLayer(layer_Residuosindustriales_0);
...
mapas[0].createPane('pane_Residuosganados_1');
mapas[0].getPane('pane_Residuosganados_1').style.zIndex = 401;
mapas[0].getPane('pane_Residuosganados_1').style['mix-blend-mode'] = 'normal';
...
mapas[0].addLayer(layer_Residuosganados_1);
...
mapas[0].createPane('pane_Residuosdebosques_2');
mapas[0].getPane('pane_Residuosdebosques_2').style.zIndex = 402;
mapas[0].getPane('pane_Residuosdebosques_2').style['mix-blend-mode'] = 'normal';
...
mapas[0].addLayer(layer_Residuosdebosques_2);
var baseMaps = {};
