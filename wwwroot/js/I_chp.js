        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                datosExpendios = response.filter(function (coordenada) {
                    return coordenada.clasificacion === "Cogeneración";
                });
                ...
                for (var j = 0; j < response.length; j++) {
                    ...
                    if (coordenada.clasificacion === "Cogeneración") {
                        var iconoActual;
                ...
                var cogeneracion = processData(datosExpendios, 'efId');
                //Grafico de Columnas
                ...
                var options = {
                    ...
                    xAxis: {
                        categories: cogeneracion.categories
                    },
                    yAxis: {
                        title: {
