...
// Función para asignar colores según el voltaje
...
// Función para estilizar las features (líneas) del GeoJSON y agregar pop-up y efecto hover
function stylelt(feature) {
    var voltaje = feature.properties.Voltaje_KV;
    var color = getColorlt(voltaje);
...
// Agregar la capa GeoJSON al mapa con el nuevo estilo, pop-up y efectos hover
    ...
    function updatePopupContent() {
        var popupContent = '<table>\
                                    ...
                                    <tr>\
                                        ...
                                        <td>' + (feature.properties['Voltaje_KV'] !== null ? autolinker.link(feature.properties['Voltaje_KV'].toLocaleString()) : '') + '</td>\
                                    </tr>\
                                    <tr>\
...
map.getPane('pane_subestaciones_0').style['mix-blend-mode'] = 'normal';
var layer_subestaciones_0 = new L.geoJson(json_subestaciones_0, {
    attribution: '',
    interactive: true,
    dataVar: 'json_subestaciones_0',
    layerName: 'layer_subestaciones_0',
    pane: 'pane_subestaciones_0',
