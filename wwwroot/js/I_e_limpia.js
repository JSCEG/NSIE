        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                datosExpendios = response.filter(function (coordenada) {
                    return coordenada.fuenteEnergia === "Renovable";
                });
                    ...
                    if (camposVisiblesGlobal.includes("RazonSocial")) {
                        ...
                        switch (coordenada.tipoPermiso) {
                            ...
                            case "Expendio al Público de Gas Licuado de Petróleo mediante Estación de Servicio con fin Específico":
                                ...
                                break; */
                            default:
                                imgSrc = 'https://cdn.sassoapps.com/img_snier/vistas/energia_limpia2.png'; // Ícono por defecto si no hay coincidencia
                                break;
                        }
                ...
                var iconoExpendio = new iconoBase({ iconUrl: 'https://cdn.sassoapps.com/img_snier/vistas/energia_limpia2.png' });
                ...
                for (var j = 0; j < response.length; j++) {
                    ...
                    if (coordenada.fuenteEnergia === "Renovable") {
                        var iconoActual;
                ...
                var limpia = processData(datosExpendios, 'efId');
                //Grafico de Columnas
