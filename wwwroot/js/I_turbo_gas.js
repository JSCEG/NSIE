        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                datosExpendios = response.filter(function (coordenada) {
                    return coordenada.clasificacion === "Turbo Gas y Vapor";
                });
                ...
                for (var j = 0; j < response.length; j++) {
                    ...
                    if (coordenada.clasificacion === "Turbo Gas y Vapor") {
                        var iconoActual;
...
// Funcionalidades de busqueda y Menu
