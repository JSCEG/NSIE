        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                datosExpendios = response.filter(function (coordenada) {
                    return coordenada.clasificacion === "Geotérmica";
                });
                ...
                for (var j = 0; j < response.length; j++) {
                    ...
                    if (coordenada.clasificacion === "Geotérmica") {
                        var iconoActual;
...
mapas[0].createPane('pane_Geotermica_ok_4326_0');
mapas[0].getPane('pane_Geotermica_ok_4326_0').style.zIndex = 400;
mapas[0].getPane('pane_Geotermica_ok_4326_0').style['mix-blend-mode'] = 'normal';
...
mapas[0].addLayer(layer_Geotermica_ok_4326_0);
setBounds();
