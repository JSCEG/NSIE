        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                datosExpendios = response.filter(function (coordenada) {
                    return coordenada.clasificacion === "Hidroeléctrica";
                });
                    ...
                    if (camposVisiblesGlobal.includes("RazonSocial")) {
                        ...
                        switch (coordenada.tipoPermiso) {
                            ...
                            case "Expendio al Público de Gas Licuado de Petróleo mediante Estación de Servicio con fin Específico":
                                ...
                                break; */
                            default:
                                imgSrc = 'https://cdn.sassoapps.com/img_snier/vistas/hidro.png'; // Ícono por defecto si no hay coincidencia
                                break;
                        }
                ...
                var iconoExpendio = new iconoBase({ iconUrl: 'https://cdn.sassoapps.com/img_snier/vistas/hidro.png' });
                ...
                for (var j = 0; j < response.length; j++) {
                    ...
                    if (coordenada.clasificacion === "Hidroeléctrica") {
                        var iconoActual;
...
mapas[0].createPane('pane_Cuencas_Disponibilidad_2023copiar_0');
mapas[0].getPane('pane_Cuencas_Disponibilidad_2023copiar_0').style.zIndex = 400;
mapas[0].getPane('pane_Cuencas_Disponibilidad_2023copiar_0').style['mix-blend-mode'] = 'normal';
...
mapas[0].addLayer(layer_Cuencas_Disponibilidad_2023copiar_0);
