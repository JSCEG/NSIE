    ...
    cargarCamposVisibles().then(camposVisibles => {
        ...
        $.ajax({
            ...
            success: function (response) {
                    ...
                    if (camposVisiblesGlobal.includes("RazonSocial")) {
                        ...
                        switch (coordenada.tipoPermiso) {
                            ...
                            case "Expendio al Público de Gas Licuado de Petróleo mediante Estación de Servicio con fin Específico":
                                ...
                                break; */
                            default:
                                imgSrc = 'https://cdn.sassoapps.com/img_snier/vistas/eolica.png'; // Ícono por defecto si no hay coincidencia
                                break;
                        }
                ...
                var iconoExpendio = new iconoBase({ iconUrl: 'https://cdn.sassoapps.com/img_snier/vistas/eolica.png' });
                ...
                for (var j = 0; j < response.length; j++) {
                    ...
                    if (coordenada.clasificacion === "Eólica") {
                        var iconoActual;
...
var capaRaster = L.imageOverlay(urlRaster, bounds).addTo(mapas[0]);
