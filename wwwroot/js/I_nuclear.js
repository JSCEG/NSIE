...
mapas[0].on('click', function (e) {
    let lat = e.latlng.lat.toPrecision(8);
    let lon = e.latlng.lng.toPrecision(8);
    const point = L.marker([lat, lon]).addTo(mapas[0])
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                datosExpendios = response.filter(function (coordenada) {
                    return coordenada.clasificacion === "Nucleoeléctrica";
                });
                    ...
                    if (camposVisiblesGlobal.includes("RazonSocial")) {
                        ...
                        switch (coordenada.tipoPermiso) {
                            ...
                            case "Expendio al Público de Gas Licuado de Petróleo mediante Estación de Servicio con fin Específico":
                                ...
                                break; */
                            default:
                                imgSrc = 'https://cdn.sassoapps.com/img_snier/vistas/nuclear.png'; // Ícono por defecto si no hay coincidencia
                                break;
                        }
                ...
                var iconoExpendio = new iconoBase({ iconUrl: 'https://cdn.sassoapps.com/img_snier/vistas/nuclear.png' });
                ...
                for (var j = 0; j < response.length; j++) {
                    ...
                    if (coordenada.clasificacion === "Nucleoeléctrica") {
                        var iconoActual;
...
mapas[0].createPane('pane_Uranio_0');
mapas[0].getPane('pane_Uranio_0').style.zIndex = 400;
mapas[0].getPane('pane_Uranio_0').style['mix-blend-mode'] = 'normal';
...
mapas[0].addLayer(layer_Uranio_0);
setBounds();
