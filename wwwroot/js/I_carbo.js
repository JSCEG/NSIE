        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                datosExpendios = response.filter(function (coordenada) {
                    return coordenada.clasificacion === "Carboeléctrica";
                });
                ...
                for (var j = 0; j < response.length; j++) {
                    ...
                    if (coordenada.clasificacion === "Carboeléctrica") {
                        var iconoActual;
...
mapas[0].createPane('pane_carbon_0');
mapas[0].getPane('pane_carbon_0').style.zIndex = 400;
mapas[0].getPane('pane_carbon_0').style['mix-blend-mode'] = 'normal';
...
mapas[0].addLayer(layer_carbon_0);
setBounds();
