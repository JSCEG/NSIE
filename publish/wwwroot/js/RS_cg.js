    ...
    cargarCamposVisibles().then(camposVisibles => {
        ...
        $.ajax({
            ...
            success: function (response) {
                    ...
                    if (camposVisiblesGlobal.includes("Nombre")) {
                        ...
                        switch (coordenada.tipoPermiso) {
                            ...
                            case "Expendio al Público de Gas Licuado de Petróleo mediante Estación de Servicio con fin Específico":
                                ...
                                break; */
                            default:
                                imgSrc = '/img/gasnatural.png'; // Ícono por defecto si no hay coincidencia
                                break;
                        }
                ...
                var iconoExpendio = new iconoBase({ iconUrl: '/img/gasnatural.png' });
...
$(document).ready(function () {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            Highcharts.chart('graficocg', {
                chart: {
                    type: 'line' // o 'column', 'bar', etc.
                },
                title: {
                    text: 'Datos de Complejos de Gas en (PJ) por Año'
                },
                xAxis: {
                ...
                series: [
                    ...
                    {
                        name: 'Complejos de Gas en (PJ)',
                        data: data.map(item => item.complejosGas)
                    }
